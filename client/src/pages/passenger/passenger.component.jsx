...
class Passenger extends React.Component{
   ...
   try{ 
    ...
    toast.success('Payment Successful !', {
        ...
        await axios.patch(`/${this.props.match.params.id}`,{passengers:JSON.stringify(this.state.passengersInfo)});
    }
    catch(e)
    {
...
async componentDidMount (){
       const axiosRes=await axios.get(`/${this.props.match.params.id}`)
